...
def count_bad_moment(movedays, staydays, minedays):
    ...
    water_need = (movedays*2+staydays) * \
        water_consume[1]+minedays*3*water_consume[0]
    food_need = (movedays*2+staydays) * \
...
def count_start_fund(movedays, staydays, minedays):
    ...
    water_need = (movedays*2+staydays+minedays*3)*water_consume[1]
    food_need = (movedays*2+staydays+minedays*3)*food_consume[1]
